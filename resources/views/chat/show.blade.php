...
<head>
    ...
    <title>Chat with {{ $serviceRequest->user->name ?? 'User' }}</title>
    @include('header.pheader') {{-- Or your user header include --}}
    @include('sidebar.providersidebar.ssidebar') {{-- Or your user sidebar include --}}
    ...
    <style>
        ...
        .chat-header h2 {
            font-size: 2.6rem; /* More prominent header */
            color: #37474f;
            margin: 0;
        ...
        .chat-messages {
            ...
            display: flex;
            flex-direction: column;
            padding-bottom: 60px; /* Make space for potential tail */
        }
        ...
        .message.sent {
            ...
            box-shadow: 1px 1px 3px rgba(0, 0, 0, 0.08); /* Subtle shadow for sent */
        }
        ...
        .message.received {
            ...
            box-shadow: -1px 1px 3px rgba(0, 0, 0, 0.08); /* Subtle shadow for received */
        }

        /* Tail Indicators (Optional) */
        .message::before {
            content: '';
            position: absolute;
            border-width: 8px;
        ...
        .chat-input-wrapper {
            ...
            border-radius: 25px;
            overflow: hidden; /* For consistent rounded borders */
            display: flex;
            align-items: center;
            padding-left: 15px;
            padding-right: 5px; /* Space for potential icon */
            margin-right: 15px;
            background-color: #fff; /* Ensure background for rounded borders */
        }
        ...
        .send-button i {
            margin-left: 8px; /* Space for send icon */
        }
        ...
        /* Read Status/Delivery Indicators (Advanced - Placeholder) */
        .message-status {
            font-size: 0.7rem;
            color: #90a4ae;
            margin-left: 5px;
    ...
    <div class="main-content">
        <div class="chat-container">
            <div class="chat-header">
                <h2>Chat with {{ $serviceRequest->user->name ?? 'User' }}</h2>
