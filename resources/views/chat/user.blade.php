...
<head>
    ...
    <style>
        ...
        .chat-messages {
            ...
            display: flex;
            flex-direction: column;
            padding-bottom: 60px; /* Space for potential last message */
        }
        .message-container {
            display: flex;
            flex-direction: column;
        ...
        .message.sent {
            background-color: #a7d9ed; /* More vibrant blue */
            color: #0d47a1; /* Darker blue text */
            border-bottom-right-radius: 0;
            box-shadow: 1px 1px 3px rgba(0, 0, 0, 0.08);
        }
        .message.received {
            background-color: #dcedc8; /* More vibrant light green */
        ...
        .message.sent::before {
            right: -8px;
            border-color: transparent transparent #a7d9ed #a7d9ed;
            border-bottom-right-radius: 5px;
        }
        .message.received::before {
            left: -8px;
            border-color: transparent #dcedc8 #dcedc8 transparent;
            border-top-left-radius: 5px;
        }
        .message .sender {
            font-size: 0.9rem;
            color: #546e7a; /* Slightly darker sender name */
            margin-bottom: 5px;
            font-weight: 500;
        }
        .message small.text-muted {
            ...
            font-size: 0.7rem;
            margin-top: 5px;
            color: #78909c; /* Slightly darker timestamp */
        }
        .chat-input-area {
        ...
        .chat-input-wrapper {
            ...
            padding-left: 15px;
            padding-right: 5px;
            margin-right: 15px; /* Add margin to the right of input */
            background-color: #fff;
        }
        .chat-input {
            flex-grow: 1;
