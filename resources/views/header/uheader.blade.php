...
<head>
    ...
    <style>
        ...
        body {
            padding-top: 70px;
            /* So content doesn't go under fixed navbar */
        }
        ...
        * {
        ...
        /* --- UPDATED SEARCH BAR AND SUGGESTIONS BOX STYLES --- */
        .search-bar {
            display: flex;
            align-items: center;
            position: relative;
            /* Added: Establishes positioning context for absolute children */
        }
        ...
        .suggestions-box {
            ...
            left: 0;
            /* Aligns it with the left edge of the search bar */
            width: 100%;
            /* Makes it the same width as the search bar container */
            background: white;
            border: 1px solid #ccc;
            max-height: 200px;
            overflow-y: auto;
        ...
        /* --- END UPDATED SEARCH BAR AND SUGGESTIONS BOX STYLES --- */
        ...
        .user-dropdown-content a {
            ...
            border-radius: 5px;
            /* Add border-radius for the button look */
            font-weight: bold;
            /* Make the text bold like the Logout button */
            margin-bottom: 5px;
            /* Add a little spacing between buttons */
        }
        ...
        .user-dropdown-content button {
            ...
            transition: background-color 0.3s ease;
            border-radius: 5px;
            /* Add border-radius for the button */
            font-weight: bold;
            margin-top: 5px;
            /* Add a little spacing between buttons */
        }
        ...
        @media (max-width: 768px) {
            ...
            .right-section {
                width: 100%;
                justify-content: space-between;
                /* Distribute user info and dropdown */
            }
...
<body>
    <nav class="navbar">
        ...
        <form class="search-bar" action="{{ route('searchh') }}" method="GET">
