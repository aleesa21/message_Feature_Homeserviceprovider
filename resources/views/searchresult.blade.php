...
<head>
    ...
    <style>
        ...
        .services-section {
            position: relative;
            top: -80px;
            /* Adjust this value to float above the carousel */
        ...
        .service-type {
            ...
            color: white;
            padding: 5px 12px;
            /* Adjust padding for text fitting */
            border-radius: 20px;
            /* Rounded corners */
            font-size: 13px;
            font-weight: 500;
...
<body>
    ...
    @foreach($users as $user)
    <a href="{{ route('provider.details', $user->id) }}" class="provider-link">
        <div class="provider-card">
            ...
            <div class="provider-details">
                ...
                <div class="service-types">
                    @foreach(json_decode($user->service_type, true) as $service)
